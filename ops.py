...
def c7s1_k(input, k, reuse=False, norm='instance', activation='relu', is_training=True, name='c7s1_k'):
    ...
    with tf.variable_scope(name, reuse=reuse):
        ...
        # Input dimension is (batch_size x width x height x d)
...
def uk(input, k, reuse=False, norm='instance', is_training=True, name=None, output_length=None, output_height=None):
